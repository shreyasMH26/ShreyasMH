...
// --- FlipCard Component ---
const IMG_WIDTH = 64;  // Scaled for crisp display
const IMG_HEIGHT = 90;
...
export default function IntroAnimation({
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            // If user reaches the edge of the virtual animation, allow page scrolling
            if ((current >= MAX_SCROLL && e.deltaY > 0) || (current <= 0 && e.deltaY < 0)) {
                return;
            }

            // Prevent default inside the interactive zone
            e.preventDefault();
